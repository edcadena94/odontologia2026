...
<head>
  ...
  <title>Pacientes - Esthetyc Dental Studio</title>
...
<main class="main-content">
  ...
  <div class="page-header">
    ...
    <a href="registrarPaciente.jsp" class="btn-nuevo">
  ...
  <div class="table-container">
    ...
    <table>
      ...
      <tr>
        ...
        <td>
                            <span class="badge <%= p.getSexo() == 'M' ? "badge-m" : "badge-f" %>">
                                <%= p.getSexo() == 'M' ? "Masculino" : "Femenino" %>
                            </span>
        </td>
        <td>
          <div class="actions">
            <a href="pacientes?accion=editar&id=<%= p.getIdPaciente() %>" class="btn-action btn-edit" title="Editar">
              <i class="fas fa-edit"></i>
            </a>
            <a href="pacientes?accion=eliminar&id=<%= p.getIdPaciente() %>" class="btn-action btn-delete" title="Eliminar" onclick="return confirm('¿Está seguro de eliminar este paciente?')">
