...
<head>
    ...
    <title>Agendar Cita - Esthetyc Dental Studio</title>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="idPaciente" required>
                        ...
                        %>
                        <option value="<%= p.getIdPaciente() %>"><%= p.getNombre() %> <%= p.getApellido() %></option>
                        <%
                                }
                            }
                        %>
                ...
                <div class="form-group">
                    ...
                    <select name="idDoctor" required>
                        ...
                        %>
                        <option value="<%= d.getIdDoctor() %>">Dr. <%= d.getNombre() %> <%= d.getApellido() %> - <%= d.getEspecialidad() %></option>
                        <%
                                }
                            }
                        %>
