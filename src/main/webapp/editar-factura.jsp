...
<head>
    ...
    <title>Editar Factura - Esthetyc Dental Studio</title>
...
<main class="main-content">
    ...
    <div class="page-header">
        <h1><i class="fas fa-edit"></i> Editar Factura</h1>
        ...
        <form action="factura" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="numeroFactura" value="<%= factura.getNumeroFactura() %>" required>
                </div>

                <!-- Fecha -->
                <div class="form-group">
                    <label><i class="fas fa-calendar"></i> Fecha</label>
                    <input type="date" name="fecha" value="<%= factura.getFecha() %>" required>
                </div>

                <!-- ID Paciente -->
                <div class="form-group">
                    <label><i class="fas fa-user"></i> ID del Paciente</label>
                    <input type="number" name="idPaciente" value="<%= factura.getIdPaciente() %>" required min="1">
                </div>

                <!-- Monto Total -->
                <div class="form-group">
                    <label><i class="fas fa-dollar-sign"></i> Monto Total</label>
                    <input type="number" name="montoTotal" value="<%= factura.getMontoTotal() %>" step="0.01" required min="0">
                </div>
            </div>
